...
export default function PostCard({ post, locale }: PostCardProps) {
  ...
  return (
    <article className="rounded-lg border border-gray-200 bg-white overflow-hidden shadow-sm transition-shadow hover:shadow-md dark:border-gray-700 dark:bg-gray-800">
      {post.image && (
